  ...
  return (
    <div className='grid grid-cols-2 gap-5 m-20'>
      ...
      <Dialog>
        <DialogTrigger>
          <div 
            className='rounded-2xl border-2 border-solid border-gray-300 flex flex-row items-center  h-32 px-8 hover:shadow-md hover:shadow-gray-300 transition-all cursor-pointer text-left'>
