...
const StudentInfoComponent: React.FC<StudentInfoProps> = ({ studentId }) => {
    ...
    return (
        <Dialog>
            <DialogTrigger className='border-gray-700 border-[1px] text-black px-3 py-1 rounded-sm text-ellipsis text-sm hover:bg-black hover:text-white transition-all'>
                Info
            </DialogTrigger>
